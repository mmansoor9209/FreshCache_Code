...
POLICIES = ["NoCache", "SemanticTTL_k1_16", "FreshCache_NoL1", "FreshCache"]
C18 = {"FreshCache"}
...
def main():
    ...
    rows = []
    for pol in POLICIES:
        use_l1 = pol in ("FreshCache", "SemanticTTL_k1_16")
        use_l2 = pol in ("FreshCache", "FreshCache_NoL1")
        use_l3 = use_l2
        for r in spec["specs"][pol]:
            ...
            if pol != "NoCache" and r["path"] != "realtime_bypass":
